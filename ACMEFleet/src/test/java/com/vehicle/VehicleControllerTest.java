...
class VehicleControllerTest {
	...
	private final VehicleRepositoryTest repository;

	VehicleControllerTest(VehicleRepositoryTest repository) {
	...
	Page<Vehicle> findByMakeSorted(@RequestParam(value = "make", required = false) String make,
		...
		Pageable requestedPage = PageRequest.of(page, size, Sort.by("year").descending());
